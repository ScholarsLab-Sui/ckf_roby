...
class Camera(abc.ABC):
    ...
    def __init__(self, config: CameraConfig):
        ...
        """
        self.fps: Optional[int] = config.fps
        self.width: Optional[int] = config.width
        self.height: Optional[int] = config.height
    ...
    @abc.abstractmethod
    def read(self, color_mode: Optional[ColorMode] = None) -> np.ndarray:
