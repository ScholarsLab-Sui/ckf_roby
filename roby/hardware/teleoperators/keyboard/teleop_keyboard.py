...
from roby.hardware.teleoperators.keyboard.configuration_keyboard import KeyboardEndEffectorTeleopConfig, KeyboardTeleopConfig
...
@dataclass
class KeyboardOutput(BaseHardwareOutput):
    """
    Output class for keyboard teleoperation.
    This class is used to represent the state of the keyboard inputs.
    """

    pressed_keys: dict[str, bool] = None
...
class KeyboardTeleop(Teleoperator):
    ...
    def get_action(self) -> dict[str, Any]:
        ...
        return KeyboardOutput(
            ...
            pressed_keys=dict.fromkeys(action, None)
        )
...
if __name__ == "__main__":
    ...
    keyboard_teleop = KeyboardTeleop(config)
    ...
    try:
        ...
        print("Keyboard teleoperation stopped.")